...
VALUES ('license.read', 'LICENSE_READ', (SELECT id FROM role_types WHERE slug = 'TEAM_ROLE'));
...
INSERT INTO roles (role_name, slug, role_type)
VALUES ('license.write', 'LICENSE_WRITE', (SELECT id FROM role_types WHERE slug = 'TEAM_ROLE'));
...
-- USER
INSERT INTO roles (role_name, slug, role_type)
VALUES ('user.read', 'USER_READ', (SELECT id FROM role_types WHERE slug = 'TEAM_ROLE'));
...
INSERT INTO roles (role_name, slug, role_type)
VALUES ('user.write', 'USER_WRITE', (SELECT id FROM role_types WHERE slug = 'TEAM_ROLE'));
...
INSERT INTO roles (role_name, slug, role_type)
VALUES ('user.delete', 'USER_DELETE', (SELECT id FROM role_types WHERE slug = 'TEAM_ROLE'));
...
-- SESSION
INSERT INTO roles (role_name, slug, role_type)
VALUES ('session.read', 'SESSION_READ', (SELECT id FROM role_types WHERE slug = 'TEAM_ROLE'));
...
INSERT INTO roles (role_name, slug, role_type)
VALUES ('session.write', 'SESSION_WRITE', (SELECT id FROM role_types WHERE slug = 'TEAM_ROLE'));
...
INSERT INTO role_scopes
SELECT (SELECT role_id FROM roles WHERE slug = 'TEAM_DELETE'), scopes.scope_id, scope_type
FROM scopes
         JOIN scope_types ON scopes.scope_type = scope_types.id
         JOIN scope_categories ON scopes.category_id = scope_categories.id
         JOIN permission_impact_levels ON scopes.impact_level_id = permission_impact_levels.id
