...
public class User
{
    ...
    [Column("key_reset_count")] public int? KeyResetCount { get; set; }

    [Column("discord_user")] public long? DiscordUser { get; set; }

    [Column("hwid")] public long? Hwid { get; set; }

    [Column("persistent_token")]
    [StringLength(40)]
    public string? PersistentToken { get; set; }

    [Column("last_token")] public DateTime? LastToken { get; set; }
