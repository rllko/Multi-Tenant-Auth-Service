...
import { ChevronRight, Copy, Terminal, Code, FileText, CheckCircle } from "lucide-react"
        ...
        <main className="flex-1 min-w-0">
          ...
          <div className="prose prose-gray max-w-none">
            <p className="lead text-xl text-muted-foreground mb-8">
              Welcome to the Authio API documentation. This guide will help you get started with integrating Authio into
              your applications.
            </p>
            ...
            <p>
              All API requests must be authenticated using your API key. You can obtain an API key from your Authio
              dashboard.
            </p>
...
async function authenticateUser(username, password) {
  try {
    ...
    throw error;
            ...
            <p>
              The Authio API uses conventional HTTP response codes to indicate the success or failure of an API request.
            ...
            <ul className="list-disc pl-6 my-4 space-y-2">
              ...
              <li>
                <strong>400 - Bad Request:</strong> The request was unacceptable, often due to missing a required
                parameter.
              </li>
              <li>
              ...
              <li>
                <strong>403 - Forbidden:</strong> The API key doesn't have permissions to perform the request.
              </li>
              <li>
              ...
              <li>
                <strong>500, 502, 503, 504 - Server Errors:</strong> Something went wrong on Authio's end.
              </li>
            </ul>
            ...
            <p>Now that you understand the basics, you can explore more specific aspects of the Authio API:</p>
