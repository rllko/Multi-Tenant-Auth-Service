...
export function ApplicationsView() {
    ...
    const handleSaveScopes = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_API_URL}/teams/${selectedTeam.id}/apps/${selectedApp.id}/permissions`,
                {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const toggleClientStatus = async (appId, currentStatus) => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/teams/${selectedTeam.id}/apps/${appId}/permissions`, {
                method: "PATCH",
                headers: {
                    "Content-Type": "application/json",
                },
                        ...
                        {!loading && !error && filteredApps.length === 0 ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {filteredApps.map((app) => (
                                    <Card key={app.id}
                                          className="overflow-hidden bg-card dark:bg-[#1E1E1E] border-border">
                                            ...
                                            <div className="space-y-2">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="flex gap-1">
                                                        ...
                                                        >
                                                            {secretVisibility[app.id] ? <EyeOff className="h-3 w-3"/> :
                                    ...
                                    <TableBody>
                                        {filteredApps.map((app) => (
                                            <TableRow key={app.id} className="hover:bg-muted/30">
                                                ...
                                                <TableCell
                                                    className="text-sm text-muted-foreground">{app.lastUsed || "Never"}</TableCell>
                                                <TableCell>
                                                    <DropdownMenu>
                                                        <DropdownMenuTrigger asChild>
                                                            <Button variant="ghost" size="icon">
                                ...
                                <div className="grid gap-4">
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            Where to redirect users after authorization. Required for Authorization Code
                                            and Implicit flows.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <div className="border rounded-md p-3 min-h-[100px] bg-muted/30">
                                            {newApp.scopes && newApp.scopes.length > 0 ? (
                                                ...
                                                <p className="text-sm text-muted-foreground">
                                                    No permissions selected. Choose a role template or add permissions
                                                    manually.
                                                </p>
                                            )}
                                        </div>
                                ...
                                <div className="grid gap-4">
                                    ...
                                    {newApp.keyFormat === "random" && (
                                        <div className="grid gap-2">
                                            ...
                                            <p className="text-xs text-muted-foreground">Length of the random string
                                                (8-32 characters)</p>
                                        </div>
                                    )}
