...
const logs = [
    {
        ...
        action: "create",
        severity: "info",
        description: "License key AUTHIO-1234-5678-9ABC-DEFG created",
        user: "admin@example.com",
        entity: "AUTHIO-1234-5678-9ABC-DEFG",
        entityType: "license",
        metadata: {
            plan: "Pro",
    ...
    },
    {
        ...
        action: "revoke",
        severity: "warning",
        description: "License key AUTHIO-3456-7890-ABCD-EFGH revoked",
        user: "admin@example.com",
        entity: "AUTHIO-3456-7890-ABCD-EFGH",
        entityType: "license",
        metadata: {
    ...
    },
    {
        ...
        action: "hwid_reset",
        severity: "warning",
        description: "HWID reset for license AUTHIO-2345-6789-ABCD-EFGH",
        user: "support@example.com",
        entity: "AUTHIO-2345-6789-ABCD-EFGH",
        entityType: "license",
        metadata: {
    ...
    },
    {
        ...
        action: "extend",
        severity: "info",
        description: "License AUTHIO-1234-5678-9ABC-DEFG extended by 30 days",
        user: "admin@example.com",
        entity: "AUTHIO-1234-5678-9ABC-DEFG",
        entityType: "license",
        metadata: {
    ...
    },
    {
        ...
        action: "ban",
        severity: "error",
        description: "License AUTHIO-5678-9012-ABCD-EFGH banned",
        user: "admin@example.com",
        entity: "AUTHIO-5678-9012-ABCD-EFGH",
        entityType: "license",
        metadata: {
                                    ...
                                    {filteredLogs.length === 0 ? (
                                        ...
                                        filteredLogs.map((log) => (
                                            <TableRow key={log.id} className="hover:bg-gray-50">
                                                <TableCell
                                                    className="whitespace-nowrap">{formatTimestamp(log.timestamp)}</TableCell>
                                                <TableCell>
