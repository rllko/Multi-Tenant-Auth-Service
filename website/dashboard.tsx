            ...
            <div className="flex flex-1 flex-col min-w-0 w-full overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto">
                    <div className="mx-auto max-w-7xl p-2 sm:p-3 md:p-4 lg:p-6">
                        ...
                        {activeView === "scopes" && (
                            <>
                                <h1 className="text-lg sm:text-xl md:text-2xl font-bold tracking-tight mb-3 sm:mb-4">OAuth
                                    Scopes</h1>
                                <ScopesView/>
                            </>
                        )}
                        ...
                        {activeView === "licenses" && (
                            <>
                                <h1 className="text-lg sm:text-xl md:text-2xl font-bold tracking-tight mb-3 sm:mb-4">License
                                    Keys</h1>
                                <LicenseKeysView/>
                            </>
                        )}
                        ...
                        {activeView === "logs" && (
                            <>
                                <h1 className="text-lg sm:text-xl md:text-2xl font-bold tracking-tight mb-3 sm:mb-4">Activity
                                    Logs</h1>
                                <LoggingView/>
                            </>
                        )}
                        ...
                        {activeView === "files" && (
                            <>
                                <h1 className="text-lg sm:text-xl md:text-2xl font-bold tracking-tight mb-3 sm:mb-4">File
                                    Storage</h1>
                                <FilesView/>
                            </>
                        )}
